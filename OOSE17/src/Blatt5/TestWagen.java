...
public class TestWagen {
	...
	public static void main(String[] args) {
		...
		//Es ändern sich Ausgabe 3 und 4, denn die Klasse Lastwagen überschreibt nun nicht mehr die die getReifen() Funktion und erbt somit die 
		//Funktion von Auto, die auf die Variable reifen von Auto verweist bzw. zurückgibt. Bei Ausgabe2 wird auto1 auf Lastwagen getypcastet, deswegen
		...
		//Ausgabe 1 und 2 sind nicht betroffen, weil die Funktion ja gar nicht aufgerufen wird und Ausgabe 4 ist funktionsfähig, weil auto1 zu Lastwagen
